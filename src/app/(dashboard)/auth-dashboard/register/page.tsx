...
import {
  ...
  Step4,
  Step5,
} from "@/src/components/Register/FormSteps";
              ...
              <div className="flex gap-3">
                {step > 1 && (
                  <button
                    type="button"
                    onClick={prevStep}
                    className="px-6 py-4 border-2 border-neutral-100 rounded-2xl font-black text-neutral-400 hover:bg-neutral-50 flex items-center gap-2"
                  >
