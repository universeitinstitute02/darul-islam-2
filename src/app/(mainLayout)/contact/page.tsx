        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <motion.div
              ...
              className="bg-[#0B3D2E] p-8 rounded-3xl shadow-xl space-y-4 text-[#F5EFE1]"
            >
              <div className="w-12 h-12 bg-[#8FE3A9] text-[#0B3D2E] rounded-2xl flex items-center justify-center">
                <Clock size={24} />
              </div>
          ...
          <div className="lg:col-span-2">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.2 }}
              className="mt-12 bg-white p-4 rounded-[2.5rem] shadow-xl border border-[#0B3D2E]/5 h-64 relative overflow-hidden"
            >
