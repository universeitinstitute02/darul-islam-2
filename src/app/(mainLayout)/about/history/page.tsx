      ...
      <section className="relative h-48 lg:h-64 bg-[#0B3D2E] flex items-end p-6 lg:p-12 text-white overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-screen-xl mx-auto flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm font-bold text-[#F5EFE1]/80 uppercase tracking-widest mt-1">কুরআন ও সুন্নাহর পথপ্রদর্শনের দেড় দশক</p>
          </div>
        </div>
      </section>
      ...
      <main className="max-w-screen-xl mx-auto w-full px-4 py-16 space-y-24">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-3xl lg:text-5xl font-black text-[#0B3D2E] leading-tight">
              এক নিরন্তর আধ্যাত্মিক ও বৌদ্ধিক যাত্রার গল্প
            </h2>
            <p className="text-lg text-[#0B3D2E]/80 leading-relaxed font-medium">
            ...
            <div className="flex gap-6">
              <div className="flex flex-col">
                <span className="text-4xl font-black text-[#0B3D2E]">১৫+</span>
                <span className="text-xs font-bold uppercase tracking-widest text-[#0B3D2E]/40">সফল বছর</span>
              </div>
              <div className="w-px h-12 bg-[#0B3D2E]/10" />
              <div className="flex flex-col">
                <span className="text-4xl font-black text-[#0B3D2E]">২০০+</span>
                <span className="text-xs font-bold uppercase tracking-widest text-[#0B3D2E]/40">হাফেজ শিক্ষার্থী</span>
              </div>
            </div>
          </div>
        ...
        <section className="space-y-12">
          <div className="text-center">
            <h3 className="text-2xl font-black text-[#0B3D2E] inline-block relative border-b-4 border-[#8FE3A9]">সাফল্যের মাইলফলক</h3>
          </div>
          <div className="relative py-10 space-y-12">
            <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-1 bg-[#0B3D2E]/10 -translate-x-1/2" />
            ...
            {timeline.map((item, i) => (
              ...
              >
                <div className="w-full md:w-1/2 flex justify-end">
                   <div className="bg-white p-8 rounded-3xl shadow-xl border border-[#0B3D2E]/5 w-full max-w-md">
                     <span className="text-[#8FE3A9] font-black text-2xl mb-2 block">{item.year}</span>
                     <h4 className="text-xl font-bold text-[#0B3D2E] mb-2">{item.title}</h4>
                     <p className="text-sm font-medium text-[#0B3D2E]/60 leading-relaxed">{item.desc}</p>
                   </div>
                </div>
                <div className="absolute left-4 md:left-1/2 w-8 h-8 bg-[#0B3D2E] rounded-full border-4 border-[#8FE3A9] -translate-x-1/2 shadow-lg z-10" />
        ...
        {/* Vision Statement */}
        <section className="bg-[#0B3D2E] rounded-[3rem] p-8 lg:p-16 text-center shadow-islamic-lg relative overflow-hidden">
          <Quote size={120} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white/5" />
          <h2 className="text-2xl lg:text-4xl font-black text-[#8FE3A9] mb-8 leading-tight">
            "আমাদের লক্ষ্য এমন একটি সমাজ তৈরি করা, <br /> যেখানে জ্ঞান হবে আলো এবং চরিত্র হবে অলংকার।"
          </h2>
          <div className="flex flex-col items-center gap-4">
             <div className="w-16 h-1 bg-[#8FE3A9] rounded-full" />
             <p className="text-[#F5EFE1] font-bold tracking-widest uppercase text-sm">দারুল ইসলাম ইনস্টিটিউট টিম</p>
          </div>
        </section>
      </main>
    </div>
