    ...
    <div className="flex flex-col min-h-screen bg-[#F7FBF7]">
      ...
      <section className="relative h-48 lg:h-64 bg-[#0B3D2E] flex items-end p-6 lg:p-12 text-white overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-screen-xl mx-auto flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm font-bold text-[#F5EFE1]/80 uppercase tracking-widest mt-1">অভিজ্ঞ ও নিবেদিতপ্রাণ নেতৃত্ব</p>
          </div>
        </div>
      </section>
      ...
      <main className="max-w-screen-xl mx-auto w-full px-4 py-16 space-y-24">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-6">
          <h2 className="text-3xl lg:text-5xl font-black text-[#0B3D2E]">আমাদের অভিভাবকবৃন্দ</h2>
          <p className="text-lg text-[#0B3D2E]/60 font-medium leading-relaxed">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {boardMembers.map((member, i) => (
            <motion.div 
              ...
              className="bg-white p-8 rounded-[3rem] shadow-2xl border border-[#0B3D2E]/5 group hover:border-[#8FE3A9] transition-all"
            >
              <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                <div className="shrink-0 w-32 h-32 bg-[#0B3D2E]/5 rounded-3xl border-4 border-[#8FE3A9]/20 flex items-center justify-center text-[#0B3D2E] group-hover:bg-[#0B3D2E] group-hover:text-[#F5EFE1] transition-all duration-300">
                  <Users size={64} />
                </div>
                <div className="space-y-4 text-center md:text-left flex-1">
                  <div>
                    <span className="text-[10px] font-black uppercase tracking-widest bg-[#8FE3A9]/10 text-[#0B3D2E] px-3 py-1 rounded-full mb-2 inline-block">
                      {member.role}
                    </span>
                    <h3 className="text-2xl font-black text-[#0B3D2E]">{member.name}</h3>
                  </div>
                  
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 text-sm font-bold text-[#0B3D2E]/60">
                  ...
                  <p className="text-sm font-medium text-[#0B3D2E]/50 leading-relaxed italic border-l-4 border-[#8FE3A9] pl-4">
                    "{member.bio}"
                  </p>

                  <div className="flex justify-center md:justify-start gap-4 pt-2">
                    <button className="w-8 h-8 rounded-full bg-[#0B3D2E]/5 flex items-center justify-center text-[#0B3D2E] hover:bg-[#0B3D2E] hover:text-white transition-all">
                      <Facebook size={16} />
                    </button>
                    <button className="w-8 h-8 rounded-full bg-[#0B3D2E]/5 flex items-center justify-center text-[#0B3D2E] hover:bg-[#0B3D2E] hover:text-white transition-all">
                      <Linkedin size={16} />
        ...
        {/* Commitment */}
        <section className="bg-[#0B3D2E] rounded-[3rem] p-12 lg:p-20 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-lg text-[#F5EFE1]/80 font-medium leading-relaxed">
            ...
            <div className="w-24 h-1 bg-[#8FE3A9] mx-auto rounded-full" />
          </div>
        </section>
      </main>
    </div>
