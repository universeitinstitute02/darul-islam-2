      ...
      <main className="max-w-screen-xl mx-auto w-full px-4 py-12 gap-8 grid grid-cols-1 lg:grid-cols-12">
        ...
        <aside className="lg:col-span-3 space-y-4">
          <div className="bg-white p-4 rounded-[2rem] shadow-xl border border-[#0B3D2E]/5 space-y-1">
            ...
            <button className="w-full hover:cursor-pointer flex items-center gap-3 p-4 rounded-2xl font-black text-red-500 hover:bg-red-50 transition-all">
              <LogOut size={20} />
              <span>লগআউট</span>
            </button>
          </div>
          ...
          <div className="bg-[#0B3D2E] p-6 rounded-[2rem] text-[#F5EFE1] shadow-2xl space-y-4">
            ...
            <button className="w-full bg-[#F5EFE1] text-[#0B3D2E] py-3 rounded-xl font-bold text-sm">
              যোগাযোগ করুন
            </button>
          </div>
        </aside>
            ...
            {stats.map((stat, i) => (
              ...
              >
                <div className="relative z-10">
                  ...
                  <p className="text-2xl lg:text-4xl font-black text-[#0B3D2E]">
                    {stat.value}
                  </p>
                  <p className="text-[10px] lg:text-xs font-black text-[#0B3D2E]/40 uppercase tracking-widest">
                    {stat.label}
                  </p>
                </div>
              </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                    ...
                    <div key={i} className="space-y-3">
                      <div className="flex justify-between items-center px-1">
                        <div>
                          ...
                          <p className="text-[10px] font-bold text-[#0B3D2E]/30 uppercase tracking-widest">
                            {course.detail}
                          </p>
                        </div>
                ...
                <div className="flex gap-4 overflow-x-auto no-scrollbar pb-2">
                  {badges.map((badge, i) => (
                    ...
                    >
                      ...
                      <p className="text-xs font-black text-[#0B3D2E]/60 uppercase tracking-widest">
                        {badge.name}
                      </p>
                    </motion.div>
                  ))}
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <section className="bg-[#0B3D2E] p-8 rounded-[3rem] shadow-2xl text-[#F5EFE1] space-y-6 relative overflow-hidden">
                ...
                <button className="w-full bg-[#F5EFE1] text-[#0B3D2E] py-4 rounded-2xl font-black text-sm relative z-10">
                  এডিট প্রোফাইল
                </button>
              </section>
